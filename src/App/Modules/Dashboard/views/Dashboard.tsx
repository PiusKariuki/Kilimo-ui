...
const Dashboard: React.FC = (): JSX.Element => {
  ...
  return (
    <div className=" relative">
      {/* ...................HERO SECTION............. */}
      <div
        className="flex flex-col md:flex-row  justify-center mb-32 xs:mx-4 md:mx-6 lg:mx-44 z-20
        mt-28"
      >
        <div className="flex flex-col flex-nowrap w-full mb-8 lg:mr-8">
          ...
          <p className="font-medium text-lg mb-6 text-left text-color">
            ...
            animal products and record weight. View you tasks, deliver urgent
            information to your manager,register animal products and record
            weight.
          </p>
      ...
      {/* ...................cards................ */}
      <p className="font-bold text-6xl mx-6 lg:text-8xl text-left text-color lg:mx-52 -mb-6 z-20">
        Features
      </p>
